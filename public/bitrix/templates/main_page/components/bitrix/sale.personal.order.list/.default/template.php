                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?if($order["ORDER"]["STATUS_ID"] == "A"):
                                        unset($paylink);
                                        if($order["ORDER"]["PAY_SYSTEM_ID"] == 8) $paylink = "/personal/order/yandex-kassa/?ORDER_ID=".$order["ORDER"]["ID"];
                                        if($order["ORDER"]["PAY_SYSTEM_ID"] == 5) $paylink = "/personal/order/kvit/?id=".$order["ORDER"]["ID"];
                                        if($paylink):?>
                                            <a href="<?=$paylink?>" target="_blank" style="min-width:140px" class="bx_big bx_bt_button_type_2 .bx_my_order bx_bt_button_type_3 bx_cart bx_order_action">Оплатить заказ</a>
                                        <?endif;
                                    endif?>
                                </td>
                            </tr>

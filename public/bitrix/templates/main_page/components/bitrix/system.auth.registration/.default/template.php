...
<script>
	function submitForm() {
	    var $form = $('form[name=bform]');
		var personalChecked = $form.find('input[name=AGREED_PERSONAL_DATA]').prop('checked');
		$form.find('.error-personal-data').toggle(!personalChecked);
        return personalChecked;
	}
</script>
<div class="bx-auth">
<?
...
<?endif?>
<noindex>
<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data" onsubmit="return submitForm()">
<?

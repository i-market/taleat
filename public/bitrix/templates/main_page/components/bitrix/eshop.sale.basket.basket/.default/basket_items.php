    ...
    foreach($arResult["ITEMS"]["AnDelCanBuy"] as $arBasketItems)
    {
        ?>
            <?
                        ...
                        {
                            $href=fn_get_chainpath($ar_res["IBLOCK_ID"], $ar_res["IBLOCK_SECTION_ID"]).$ar_res["CODE"].".html";
                        }
        ...
        <tr>
            ...
            <?endif;?>
            <?if (in_array("DELETE", $arParams["COLUMNS_LIST"])):?>
                <td><a class="setaside" href="<?=str_replace("#ID#", $arBasketItems["ID"], $arUrlTempl["delete"])?>">Удалить</a></td>
            <?endif;?>
        </tr>
        <?
        $i++;
...
<table class="myorders_itog" width="100%">
    <tbody>
        ...
        <?endif;?>
        <tr>
            <td width="100"><?= GetMessage("SALE_ITOGO")?>:</td>
            <td>
...
<p><strong>О наличии товара Вам сообщат после обработки заказа на электронную почту</strong></p>
<br/>
    ...
    <tbody>
        <tr>
            <td colspan="<?=$numCells?>" style="text-align:center">
                <br>
                <div class="cart-notetext"><strong><?=GetMessage("SALE_NO_ACTIVE_PRD");?></strong></div>
                <br>
                <a href="/catalog/" class="bt3"><?=GetMessage("SALE_NO_ACTIVE_PRD_START")?></a><br><br>
            </td>
        </tr>
    </tbody>
</table>

...
<table style="width: 100%">
    <tr>
        ...
        <td style="width: 50%; text-align: right">«01» июля 2017 г.</td>
    </tr>
</table>
<p>
    ...
    Интернет-магазин «taleat.ru», расположенный на доменном имени
    www.taleat.ru, может получить о Пользователе во время использования сайта
...
<p>
    ...
    ООО «Талеат-Сервис», которые организуют и (или) осуществляет обработку
...
<p>
    2.1. Использование Пользователем сайта Интернет-магазина означает согласие
...
<p>
    ...
    Интернет-магазина taleat.ru. Интернет-магазин не контролирует и не несет
...
<p>
    ...
    Администрации сайта интернет-магазина по неразглашению и обеспечению режима
...
<p>
    ...
    регистрационной формы на Сайте интернет-магазина Название магазина в
    разделе Название раздела и включают в себя следующую информацию:
</p>
<p>
...
<p>
    ...
    купли-продажи товара дистанционным способом с taleat.ru.
</p>
<p>
...
<p>
    ...
    интернет-магазина « taleat.ru», включая доставку Товара.
</p>
<p>
...
<p>
    ...
    Пользователем сайта Интернет-магазина и Администрацией сайта, обязательным
...
<p>
    ...
    следует сообщать указать раздел сайта интернет-магазина/
</p>
<p>
    9.4. Действующая Политика конфиденциальности размещена на странице по
    адресу <?= 'www.taleat.ru'.$APPLICATION->GetCurDir() ?>.
</p>

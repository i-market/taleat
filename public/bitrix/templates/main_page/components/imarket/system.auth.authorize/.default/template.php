...
<?	global $USER;
	$arGroups = CUser::GetUserGroup($USER->GetID());
		...
		if(in_array(9, $arGroups))
			{?>
			<script>window.location.href="/partneram/";</script>
			<?}
...
<?endif?>
	<div class="bx-auth-note">Пожалуйста авторизуйтесь как Партнеры <?if($arParams["NOT_SHOW_LINKS"] != "Y" && $arResult["NEW_USER_REGISTRATION"] == "Y" && $arParams["AUTHORIZE_REGISTRATION"] != "Y"):?>
		<noindex>
		
			или	<a href="/partneram/registration/" rel="nofollow">Зарегистрируйтесь</a><br />
...
<?endif?></div>
	...
	<input type="hidden" name="AUTH_FORM_PARTNER" value="Y" />
...
<?if ($arParams["NOT_SHOW_LINKS"] != "Y"):?>
		<noindex>
			<p>
				<a href="/login/?forgot_password=yes&backurl=%2Flogin%2F" rel="nofollow">Восстановление пароля</a>
			</p>
		</noindex>
<?endif?>
